            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (result == 1) {
                        ...
                        // Initialize or update display frame
                        /*if (displayFrame == null) {
                            displayFrame = new JFrame();
                            displayFrame.setLayout(new BorderLayout());
                            displayFrame.add(new JScrollPane(displayPanel), BorderLayout.CENTER);
                            displayFrame.setTitle("Voters");
                            displayFrame.setSize(400, 300);
                            displayFrame.setLocationRelativeTo(null);
                            displayFrame.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
                        } else {
                            displayFrame.remove(displayPanel);
                            displayFrame.add(new JScrollPane(displayPanel), BorderLayout.CENTER);
                        }
